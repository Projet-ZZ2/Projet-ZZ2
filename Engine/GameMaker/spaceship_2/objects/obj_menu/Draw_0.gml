...
draw_text(display_get_gui_width() / 2, 120, "GIT SHOOTER");
...
draw_text(display_get_gui_width() / 2, 420, "Echap - mettre en pause");

// Instructions pour démarrer
draw_set_color(c_teal);
draw_text(display_get_gui_width() / 2, 470, "Appuyez sur I (git init) pour commencer");
